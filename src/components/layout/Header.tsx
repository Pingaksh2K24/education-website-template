        ...
        <div className="flex justify-center items-center h-18 relative">
          ...
          <div className="hidden md:block">
            <div className="flex items-center justify-center space-x-1">
              <Link href="/" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Home
              </Link>
              <Link href="/about" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/about' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                About Us
              </Link>
              <Link href="/academics" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/academics' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Academics
              </Link>
              {/* Admissions Dropdown */}
              <div className="relative" onMouseEnter={() => setIsAdmissionOpen(true)} onMouseLeave={() => setIsAdmissionOpen(false)}>
                <button className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center ${pathname.startsWith('/admissions') ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
              ...
              <div className="relative" onMouseEnter={() => setIsDeptOpen(true)} onMouseLeave={() => setIsDeptOpen(false)}>
                <button className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center ${pathname.startsWith('/departments') ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                  }`} suppressHydrationWarning>
                  Departments
              ...
              <Link href="/faculty" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/faculty' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Faculty
              </Link>
              <Link href="/student-life" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/student-life' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Student Life
              </Link>
              <Link href="/placements" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/placements' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Placements
              </Link>
              <Link href="/alumni" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/alumni' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Alumni
              </Link>
              ...
              <div className="relative" onMouseEnter={() => setIsGalleryOpen(true)} onMouseLeave={() => setIsGalleryOpen(false)}>
                <button className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center ${pathname.startsWith('/gallery') ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                  }`} suppressHydrationWarning>
                  Gallery
              ...
              <div className="relative" onMouseEnter={() => setIsNaacOpen(true)} onMouseLeave={() => setIsNaacOpen(false)}>
                <button className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center ${pathname.startsWith('/naac') ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                  }`} suppressHydrationWarning>
                  NAAC
              ...
              <Link href="/contact" className={`px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105 ${pathname === '/contact' ? 'bg-gradient-to-r from-red-500 to-red-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                }`}>
                Contact
              </Link>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gradient-to-b from-[#022340] to-[#033a5a] border-t border-white/20 shadow-2xl">
            <div className="px-4 pt-4 pb-6 space-y-2 max-h-[80vh] overflow-y-auto">
              <Link href="/" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Home
              </Link>
              <Link href="/about" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/about' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                About Us
              </Link>
              <Link href="/academics" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/academics' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Academics
              </Link>
              ...
              <div>
                <button
                  ...
                  className={`w-full flex justify-between items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname.startsWith('/admissions') ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10'
                    }`}
                >
                  Admissions
              ...
              <div>
                <button
                  ...
                  className={`w-full flex justify-between items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname.startsWith('/departments') ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10'
                    }`}
                >
                  Departments
                ...
                {isDeptOpen && (
                  <div className="ml-6 mt-2 space-y-1 border-l-2 border-orange-400/30 pl-4">
                    ...
                    <Link href="/departments?dept=bcom" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300 hover:bg-white/5 rounded-lg transition-all duration-200" onClick={() => setIsMobileMenuOpen(false)}> Bachelor of Commerce (BCom)</Link>
              ...
              <Link href="/faculty" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/faculty' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Faculty
              </Link>
              <Link href="/student-life" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/student-life' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Student Life
              </Link>
              <Link href="/placements" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/placements' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Placements
              </Link>
              <Link href="/alumni" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/alumni' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Alumni
              </Link>
              ...
              <div>
                <button
                  ...
                  className={`w-full flex justify-between items-center px-3 py-2 rounded-md text-base font-medium ${pathname.startsWith('/gallery') ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                    }`}
                >
                  Gallery
                ...
                {isGalleryOpen && (
                  <div className="ml-4 mt-1 space-y-1">
                    <Link href="/gallery?category=all" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>All Photos</Link>
                    <Link href="/gallery?category=campus" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>Campus Life</Link>
                    <Link href="/gallery?category=events" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>Events & Functions</Link>
                    <Link href="/gallery?category=sports" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>Sports Activities</Link>
                  </div>
                )}
              </div>
              ...
              <div>
                <button
                  ...
                  className={`w-full flex justify-between items-center px-3 py-2 rounded-md text-base font-medium ${pathname.startsWith('/naac') ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white' : 'text-white hover:text-orange-300 hover:bg-white/10'
                    }`}
                >
                  NAAC
                ...
                {isNaacOpen && (
                  <div className="ml-4 mt-1 space-y-1">
                    <Link href="/naac" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>NAAC Overview</Link>
                    <Link href="/naac/accreditation" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>Accreditation Status</Link>
                    <Link href="/naac/ssr" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>Self Study Report</Link>
                    <Link href="/naac/iqac" className="block px-3 py-2 text-sm text-gray-300 hover:text-orange-300" onClick={() => setIsMobileMenuOpen(false)}>IQAC</Link>
                  </div>
                )}
              </div>
              <Link href="/contact" className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-300 ${pathname === '/contact' ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg' : 'text-white hover:text-orange-300 hover:bg-white/10 hover:translate-x-2'
                }`} onClick={() => setIsMobileMenuOpen(false)}>
                Contact
              </Link>
            </div>
